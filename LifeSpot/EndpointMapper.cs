...
namespace LifeSpot
{
    public static class EndpointMapper
    {
        ...
        ///  Маппинг Images
        /// </summary>
        public static void ConfigureImages(IApplicationBuilder app, IWebHostEnvironment env)
        {

            env.ContentRootPath = Path.Combine(Directory.GetCurrentDirectory(), "Static");
